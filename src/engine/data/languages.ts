...
export const LANGUAGES: Language[] = [
  ...
  },
  {
    ...
    onsets: ['ae', 'y', 'e', 's', 'sy', 'ly', 'el', 'ael', 'ny', 'ish'],
    medials: ['l', 'r', 'n', 'th', 'y'],
    nuclei: ['ae', 'e', 'i', 'ia', 'y', 'ei', 'ie'],
    codas: ['n', 'l', 'r', 'th'],
    endings: ['iel', 'ael', 'wyn', 'ys', 'ith', 'aria', 'ea', 'yr'],
    syllables: [2, 4],
    codaBias: 0.4,
    endingBias: 0.7,
    sharpness: 0.3,
  ...
  },
  {
    ...
    onsets: ['pyr', 'ray', 'sol', 'ser', 'ael', 'ari', 'vi', 'sy', 'ph'],
    medials: ['r', 'l', 'n', 's', 'y', 'v'],
    nuclei: ['a', 'i', 'e', 'ia', 'ae', 'io'],
    codas: ['n', 'r', 'l', 's'],
    endings: ['ael', 'ion', 'ara', 'eia', 'is', 'iel', 'ova'],
    syllables: [3, 4],
    codaBias: 0.35,
    endingBias: 0.7,
    sharpness: 0.45,
  ...
  },
  {
    ...
    families: ['celtic', 'sanskrit', 'finnish'],
    onsets: ['chry', 'sel', 'ly', 'vy', 'ny', 'ael', 'mir', 'sy', 'li'],
    medials: ['l', 'r', 'n', 's', 'y', 'v', 'th'],
    nuclei: ['i', 'ae', 'ia', 'y', 'e', 'ei'],
    codas: ['n', 'l', 'r', 's', 'th'],
    endings: ['is', 'ith', 'ael', 'ya', 'une', 'ia', 'yr'],
    syllables: [3, 4],
    codaBias: 0.4,
    endingBias: 0.7,
    sharpness: 0.3,
